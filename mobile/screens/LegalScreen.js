...
const PRIVACY = {
  ...
  sections: [
    ...
    ['Notes', 'Your own notes (text, and any photo you attach) are private to you — no colleague and no admin can read them, and you can delete them any time. Notices an admin sends you are visible only to you and the admin who wrote them; they are one-way and cannot be replied to.'],
